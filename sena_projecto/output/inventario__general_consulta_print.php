...
require_once("include/inventario__general_consulta_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "inventario_ general_consulta" );
