...
require_once("include/mega_ya_tecnicos_locking_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "mega_ya_tecnicos_locking" );
