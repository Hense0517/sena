...
require_once("include/material_reintegrado_a_bodega1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Material Reintegrado a Bodega" );
