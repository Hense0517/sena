...
function checkTableName($shortTName )
{
	...
	if ("materiales" == $shortTName )
		return true;
	if ("localidades" == $shortTName )
		return true;
	if ("reporte_de_material_gastado" == $shortTName )
		return true;
	if ("informe_de_tickets" == $shortTName )
		return true;
	if ("tickets" == $shortTName )
		return true;
	if ("ingreso_de_equipo" == $shortTName )
		return true;
	if ("ingreso_de_materiales" == $shortTName )
		return true;
	if ("empresas" == $shortTName )
		return true;
	if ("gasto_general_de_materiales" == $shortTName )
		return true;
	if ("cargue_de_materiales" == $shortTName )
		return true;
	if ("equipos_libres" == $shortTName )
		return true;
	if ("logistica_inversa" == $shortTName )
		return true;
	if ("clientes" == $shortTName )
		return true;
	if ("datos_de_red" == $shortTName )
		return true;
	if ("inventario__general" == $shortTName )
		return true;
	if ("inventario__general_consulta" == $shortTName )
		return true;
	if ("mega_ya_tecnicos_audit" == $shortTName )
		return true;
	if ("mega_ya_tecnicos_locking" == $shortTName )
		return true;
	if ("onts_cargadas" == $shortTName )
		return true;
	if ("instalaciones" == $shortTName )
		return true;
	if ("mantenimientos" == $shortTName )
		return true;
	if ("equipos_entregados_a_bodega" == $shortTName )
		return true;
	if ("retiros" == $shortTName )
		return true;
	if ("logistica_inversa_para_admin" == $shortTName )
		return true;
	if ("equipos_sin_entregar_a_bodega" == $shortTName )
		return true;
	if ("material_reintegrado_a_bodega1" == $shortTName )
		return true;
	if ("material_recuperado" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("mega_ya_tecnicos_uggroups" == $shortTName )
		return true;
	if ("mega_ya_tecnicos_ugmembers" == $shortTName )
		return true;
	if ("mega_ya_tecnicos_ugrights" == $shortTName )
		return true;
	if ("mega_ya_tecnicos_ugrights1" == $shortTName )
		return true;
	if ("usuarios" == $shortTName )
		return true;
	if ("cargue_material_a_bodega" == $shortTName )
		return true;
	if ("bodegas" == $shortTName )
		return true;
	if ("bodegas_contratista" == $shortTName )
		return true;
	if ("cargue_de_material_a_tecnicos" == $shortTName )
		return true;
	if ("cargue_de_onts_contratista" == $shortTName )
		return true;
	if ("logistica_inversa_para_contratistas" == $shortTName )
		return true;
	if ("cargue_material_a_bodega_contratistas" == $shortTName )
		return true;
	if ("cargue_de_material_a_tecnicos_contratistas" == $shortTName )
		return true;
	if ("usuarios1" == $shortTName )
		return true;
	if ("inventario_contratistas" == $shortTName )
		return true;
	if ("usuarios2" == $shortTName )
		return true;
	if ("consultar_empresa_de_usuarios1" == $shortTName )
		return true;
	if ("consultar_ticket_para_modificarlo" == $shortTName )
		return true;
	if ("tickets_contratistas" == $shortTName )
		return true;
	if ("tecnicos_contratistas" == $shortTName )
		return true;
	if ("usiarios_contratista" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("materiales");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Reporte de Material Gastado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Reporte de Material Gastado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Informe de Tickets");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Informe de Tickets";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ingreso de equipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ingreso de equipo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ingreso de materiales");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="ingreso de materiales";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Gasto general de materiales");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Gasto general de materiales";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cargue de materiales");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="cargue de materiales";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Equipos Libres");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("logistica inversa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="logistica inversa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("datos de red");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("inventario_ general");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="inventario_ general";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("inventario_ general_consulta");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="inventario_ general_consulta";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mega_ya_tecnicos_audit");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mega_ya_tecnicos_audit";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mega_ya_tecnicos_locking");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mega_ya_tecnicos_locking";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Onts Cargadas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Instalaciones");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Mantenimientos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Equipos Entregados a Bodega");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Equipos Entregados a Bodega";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Retiros");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Logistica Inversa Para Admin");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Logistica Inversa Para Admin";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Equipos sin entregar a Bodega");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Equipos sin entregar a Bodega";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Material Reintegrado a Bodega");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Material Reintegrado a Bodega";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Material Recuperado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Material Recuperado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mega_ya_tecnicos_uggroups");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mega_ya_tecnicos_uggroups";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mega_ya_tecnicos_ugmembers");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mega_ya_tecnicos_ugmembers";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mega_ya_tecnicos_ugrights");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mega_ya_tecnicos_ugrights";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mega_ya_tecnicos_ugrights1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mega_ya_tecnicos_ugrights1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Cargue Material A Bodega");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Cargue Material A Bodega";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Bodegas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Bodegas Contratista");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Bodegas Contratista";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Cargue de Material a Tecnicos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Cargue de Material a Tecnicos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Cargue de Onts Contratista");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Cargue de Onts Contratista";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Logistica Inversa Para Contratistas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Logistica Inversa Para Contratistas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Cargue Material A Bodega Contratistas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Cargue Material A Bodega Contratistas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Cargue de Material a Tecnicos Contratistas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Cargue de Material a Tecnicos Contratistas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("usuarios1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Inventario_Contratistas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Inventario_Contratistas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("usuarios2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Consultar empresa de Usuarios1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Consultar empresa de Usuarios1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Consultar Ticket Para Modificarlo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Consultar Ticket Para Modificarlo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Tickets_Contratistas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Tickets_Contratistas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Tecnicos_Contratistas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Tecnicos_Contratistas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Usiarios_Contratista");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Usiarios_Contratista";
	}
	return $arr;
}
...
//	default permissions
	...
	if( $table=="Reporte de Material Gastado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Informe de Tickets" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="ingreso de equipo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="ingreso de materiales" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Gasto general de materiales" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="cargue de materiales" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Equipos Libres" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="logistica inversa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="datos de red" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="inventario_ general" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="inventario_ general_consulta" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="mega_ya_tecnicos_audit" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="mega_ya_tecnicos_locking" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Onts Cargadas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Equipos Entregados a Bodega" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Logistica Inversa Para Admin" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Equipos sin entregar a Bodega" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Material Reintegrado a Bodega" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Material Recuperado" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="mega_ya_tecnicos_uggroups" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="mega_ya_tecnicos_ugmembers" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="mega_ya_tecnicos_ugrights" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="mega_ya_tecnicos_ugrights1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Cargue Material A Bodega" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Bodegas Contratista" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Cargue de Material a Tecnicos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Cargue de Onts Contratista" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Logistica Inversa Para Contratistas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Cargue Material A Bodega Contratistas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Cargue de Material a Tecnicos Contratistas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Inventario_Contratistas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="Consultar empresa de Usuarios1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Consultar Ticket Para Modificarlo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Tickets_Contratistas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Tecnicos_Contratistas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Usiarios_Contratista" )
	{
//	default permissions
		return "".$extraPerm;
	}
