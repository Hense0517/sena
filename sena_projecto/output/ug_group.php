...
$nonAdminTablesArr[] = "materiales";
$nonAdminTablesArr[] = "localidades";
$nonAdminTablesArr[] = "Reporte de Material Gastado";
$nonAdminTablesArr[] = "Informe de Tickets";
$nonAdminTablesArr[] = "tickets";
$nonAdminTablesArr[] = "ingreso de equipo";
$nonAdminTablesArr[] = "ingreso de materiales";
$nonAdminTablesArr[] = "empresas";
$nonAdminTablesArr[] = "Gasto general de materiales";
$nonAdminTablesArr[] = "cargue de materiales";
$nonAdminTablesArr[] = "Equipos Libres";
$nonAdminTablesArr[] = "logistica inversa";
$nonAdminTablesArr[] = "clientes";
$nonAdminTablesArr[] = "datos de red";
$nonAdminTablesArr[] = "inventario_ general";
$nonAdminTablesArr[] = "inventario_ general_consulta";
$nonAdminTablesArr[] = "mega_ya_tecnicos_audit";
$nonAdminTablesArr[] = "mega_ya_tecnicos_locking";
$nonAdminTablesArr[] = "Onts Cargadas";
$nonAdminTablesArr[] = "Instalaciones";
$nonAdminTablesArr[] = "Mantenimientos";
$nonAdminTablesArr[] = "Equipos Entregados a Bodega";
$nonAdminTablesArr[] = "Retiros";
$nonAdminTablesArr[] = "Logistica Inversa Para Admin";
$nonAdminTablesArr[] = "Equipos sin entregar a Bodega";
$nonAdminTablesArr[] = "Material Reintegrado a Bodega";
$nonAdminTablesArr[] = "Material Recuperado";
$nonAdminTablesArr[] = "mega_ya_tecnicos_uggroups";
$nonAdminTablesArr[] = "mega_ya_tecnicos_ugmembers";
$nonAdminTablesArr[] = "mega_ya_tecnicos_ugrights";
$nonAdminTablesArr[] = "mega_ya_tecnicos_ugrights1";
$nonAdminTablesArr[] = "usuarios";
$nonAdminTablesArr[] = "Cargue Material A Bodega";
$nonAdminTablesArr[] = "Bodegas";
$nonAdminTablesArr[] = "Bodegas Contratista";
$nonAdminTablesArr[] = "Cargue de Material a Tecnicos";
$nonAdminTablesArr[] = "Cargue de Onts Contratista";
$nonAdminTablesArr[] = "Logistica Inversa Para Contratistas";
$nonAdminTablesArr[] = "Cargue Material A Bodega Contratistas";
$nonAdminTablesArr[] = "Cargue de Material a Tecnicos Contratistas";
$nonAdminTablesArr[] = "usuarios1";
$nonAdminTablesArr[] = "Inventario_Contratistas";
$nonAdminTablesArr[] = "usuarios2";
$nonAdminTablesArr[] = "Consultar empresa de Usuarios1";
$nonAdminTablesArr[] = "Consultar Ticket Para Modificarlo";
$nonAdminTablesArr[] = "Tickets_Contratistas";
$nonAdminTablesArr[] = "Tecnicos_Contratistas";
$nonAdminTablesArr[] = "Usiarios_Contratista";
...
$wGroupTableName = $ug_connection->addTableWrappers( "mega_ya_tecnicos_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "mega_ya_tecnicos_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "mega_ya_tecnicos_ugrights" );
