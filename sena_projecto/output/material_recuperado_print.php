...
require_once("include/material_recuperado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Material Recuperado" );
