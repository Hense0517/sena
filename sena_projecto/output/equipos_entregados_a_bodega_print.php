...
require_once("include/equipos_entregados_a_bodega_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Equipos Entregados a Bodega" );
