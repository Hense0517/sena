...
require_once("include/consultar_ticket_para_modificarlo_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Consultar Ticket Para Modificarlo" );
