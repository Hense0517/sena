...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "mega_ya_at_localhost";
		$data["connName"] = "prueba at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;prueba;;1"; //currently unused

		$this->_connectionsIdByName["prueba at localhost"] = "mega_ya_at_localhost";
...
$pwd="0ZnjTa4iX9h";
$port="3306";
$sys_dbname="if0_34943830_soporte";
...
;
		...
		$connectionsData["mega_ya_at_localhost"] = $data;
