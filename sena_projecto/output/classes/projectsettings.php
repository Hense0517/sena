...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("admin_members", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "materiales" ] = array( "url" => "materiales", "type" => 0 );
	$projectEntitiesReverse[ "materiales" ] = "materiales";
	$projectEntities[ "localidades" ] = array( "url" => "localidades", "type" => 0 );
	$projectEntitiesReverse[ "localidades" ] = "localidades";
	$projectEntities[ "Reporte de Material Gastado" ] = array( "url" => "reporte_de_material_gastado", "type" => 2 );
	$projectEntitiesReverse[ "reporte_de_material_gastado" ] = "Reporte de Material Gastado";
	$projectEntities[ "Informe de Tickets" ] = array( "url" => "informe_de_tickets", "type" => 2 );
	$projectEntitiesReverse[ "informe_de_tickets" ] = "Informe de Tickets";
	$projectEntities[ "tickets" ] = array( "url" => "tickets", "type" => 0 );
	$projectEntitiesReverse[ "tickets" ] = "tickets";
	$projectEntities[ "ingreso de equipo" ] = array( "url" => "ingreso_de_equipo", "type" => 0 );
	$projectEntitiesReverse[ "ingreso_de_equipo" ] = "ingreso de equipo";
	$projectEntities[ "ingreso de materiales" ] = array( "url" => "ingreso_de_materiales", "type" => 0 );
	$projectEntitiesReverse[ "ingreso_de_materiales" ] = "ingreso de materiales";
	$projectEntities[ "empresas" ] = array( "url" => "empresas", "type" => 0 );
	$projectEntitiesReverse[ "empresas" ] = "empresas";
	$projectEntities[ "Gasto general de materiales" ] = array( "url" => "gasto_general_de_materiales", "type" => 2 );
	$projectEntitiesReverse[ "gasto_general_de_materiales" ] = "Gasto general de materiales";
	$projectEntities[ "cargue de materiales" ] = array( "url" => "cargue_de_materiales", "type" => 0 );
	$projectEntitiesReverse[ "cargue_de_materiales" ] = "cargue de materiales";
	$projectEntities[ "Equipos Libres" ] = array( "url" => "equipos_libres", "type" => 1 );
	$projectEntitiesReverse[ "equipos_libres" ] = "Equipos Libres";
	$projectEntities[ "logistica inversa" ] = array( "url" => "logistica_inversa", "type" => 0 );
	$projectEntitiesReverse[ "logistica_inversa" ] = "logistica inversa";
	$projectEntities[ "clientes" ] = array( "url" => "clientes", "type" => 0 );
	$projectEntitiesReverse[ "clientes" ] = "clientes";
	$projectEntities[ "datos de red" ] = array( "url" => "datos_de_red", "type" => 0 );
	$projectEntitiesReverse[ "datos_de_red" ] = "datos de red";
	$projectEntities[ "inventario_ general" ] = array( "url" => "inventario__general", "type" => 0 );
	$projectEntitiesReverse[ "inventario__general" ] = "inventario_ general";
	$projectEntities[ "inventario_ general_consulta" ] = array( "url" => "inventario__general_consulta", "type" => 1 );
	$projectEntitiesReverse[ "inventario__general_consulta" ] = "inventario_ general_consulta";
	$projectEntities[ "mega_ya_tecnicos_audit" ] = array( "url" => "mega_ya_tecnicos_audit", "type" => 0 );
	$projectEntitiesReverse[ "mega_ya_tecnicos_audit" ] = "mega_ya_tecnicos_audit";
	$projectEntities[ "mega_ya_tecnicos_locking" ] = array( "url" => "mega_ya_tecnicos_locking", "type" => 0 );
	$projectEntitiesReverse[ "mega_ya_tecnicos_locking" ] = "mega_ya_tecnicos_locking";
	$projectEntities[ "Onts Cargadas" ] = array( "url" => "onts_cargadas", "type" => 1 );
	$projectEntitiesReverse[ "onts_cargadas" ] = "Onts Cargadas";
	$projectEntities[ "Instalaciones" ] = array( "url" => "instalaciones", "type" => 1 );
	$projectEntitiesReverse[ "instalaciones" ] = "Instalaciones";
	$projectEntities[ "Mantenimientos" ] = array( "url" => "mantenimientos", "type" => 1 );
	$projectEntitiesReverse[ "mantenimientos" ] = "Mantenimientos";
	$projectEntities[ "Equipos Entregados a Bodega" ] = array( "url" => "equipos_entregados_a_bodega", "type" => 1 );
	$projectEntitiesReverse[ "equipos_entregados_a_bodega" ] = "Equipos Entregados a Bodega";
	$projectEntities[ "Retiros" ] = array( "url" => "retiros", "type" => 1 );
	$projectEntitiesReverse[ "retiros" ] = "Retiros";
	$projectEntities[ "Logistica Inversa Para Admin" ] = array( "url" => "logistica_inversa_para_admin", "type" => 1 );
	$projectEntitiesReverse[ "logistica_inversa_para_admin" ] = "Logistica Inversa Para Admin";
	$projectEntities[ "Equipos sin entregar a Bodega" ] = array( "url" => "equipos_sin_entregar_a_bodega", "type" => 1 );
	$projectEntitiesReverse[ "equipos_sin_entregar_a_bodega" ] = "Equipos sin entregar a Bodega";
	$projectEntities[ "Material Reintegrado a Bodega" ] = array( "url" => "material_reintegrado_a_bodega1", "type" => 1 );
	$projectEntitiesReverse[ "material_reintegrado_a_bodega1" ] = "Material Reintegrado a Bodega";
	$projectEntities[ "Material Recuperado" ] = array( "url" => "material_recuperado", "type" => 1 );
	$projectEntitiesReverse[ "material_recuperado" ] = "Material Recuperado";
	...
	$projectEntities[ "mega_ya_tecnicos_uggroups" ] = array( "url" => "mega_ya_tecnicos_uggroups", "type" => 0 );
	$projectEntitiesReverse[ "mega_ya_tecnicos_uggroups" ] = "mega_ya_tecnicos_uggroups";
	$projectEntities[ "mega_ya_tecnicos_ugmembers" ] = array( "url" => "mega_ya_tecnicos_ugmembers", "type" => 0 );
	$projectEntitiesReverse[ "mega_ya_tecnicos_ugmembers" ] = "mega_ya_tecnicos_ugmembers";
	$projectEntities[ "mega_ya_tecnicos_ugrights" ] = array( "url" => "mega_ya_tecnicos_ugrights", "type" => 1 );
	$projectEntitiesReverse[ "mega_ya_tecnicos_ugrights" ] = "mega_ya_tecnicos_ugrights";
	$projectEntities[ "mega_ya_tecnicos_ugrights1" ] = array( "url" => "mega_ya_tecnicos_ugrights1", "type" => 1 );
	$projectEntitiesReverse[ "mega_ya_tecnicos_ugrights1" ] = "mega_ya_tecnicos_ugrights1";
	$projectEntities[ "usuarios" ] = array( "url" => "usuarios", "type" => 1 );
	$projectEntitiesReverse[ "usuarios" ] = "usuarios";
	$projectEntities[ "Cargue Material A Bodega" ] = array( "url" => "cargue_material_a_bodega", "type" => 1 );
	$projectEntitiesReverse[ "cargue_material_a_bodega" ] = "Cargue Material A Bodega";
	$projectEntities[ "Bodegas" ] = array( "url" => "bodegas", "type" => 1 );
	$projectEntitiesReverse[ "bodegas" ] = "Bodegas";
	$projectEntities[ "Bodegas Contratista" ] = array( "url" => "bodegas_contratista", "type" => 1 );
	$projectEntitiesReverse[ "bodegas_contratista" ] = "Bodegas Contratista";
	$projectEntities[ "Cargue de Material a Tecnicos" ] = array( "url" => "cargue_de_material_a_tecnicos", "type" => 1 );
	$projectEntitiesReverse[ "cargue_de_material_a_tecnicos" ] = "Cargue de Material a Tecnicos";
	$projectEntities[ "Cargue de Onts Contratista" ] = array( "url" => "cargue_de_onts_contratista", "type" => 1 );
	$projectEntitiesReverse[ "cargue_de_onts_contratista" ] = "Cargue de Onts Contratista";
	$projectEntities[ "Logistica Inversa Para Contratistas" ] = array( "url" => "logistica_inversa_para_contratistas", "type" => 1 );
	$projectEntitiesReverse[ "logistica_inversa_para_contratistas" ] = "Logistica Inversa Para Contratistas";
	$projectEntities[ "Cargue Material A Bodega Contratistas" ] = array( "url" => "cargue_material_a_bodega_contratistas", "type" => 1 );
	$projectEntitiesReverse[ "cargue_material_a_bodega_contratistas" ] = "Cargue Material A Bodega Contratistas";
	$projectEntities[ "Cargue de Material a Tecnicos Contratistas" ] = array( "url" => "cargue_de_material_a_tecnicos_contratistas", "type" => 1 );
	$projectEntitiesReverse[ "cargue_de_material_a_tecnicos_contratistas" ] = "Cargue de Material a Tecnicos Contratistas";
	$projectEntities[ "usuarios1" ] = array( "url" => "usuarios1", "type" => 1 );
	$projectEntitiesReverse[ "usuarios1" ] = "usuarios1";
	$projectEntities[ "Inventario_Contratistas" ] = array( "url" => "inventario_contratistas", "type" => 1 );
	$projectEntitiesReverse[ "inventario_contratistas" ] = "Inventario_Contratistas";
	$projectEntities[ "usuarios2" ] = array( "url" => "usuarios2", "type" => 1 );
	$projectEntitiesReverse[ "usuarios2" ] = "usuarios2";
	$projectEntities[ "Consultar empresa de Usuarios1" ] = array( "url" => "consultar_empresa_de_usuarios1", "type" => 1 );
	$projectEntitiesReverse[ "consultar_empresa_de_usuarios1" ] = "Consultar empresa de Usuarios1";
	$projectEntities[ "Consultar Ticket Para Modificarlo" ] = array( "url" => "consultar_ticket_para_modificarlo", "type" => 1 );
	$projectEntitiesReverse[ "consultar_ticket_para_modificarlo" ] = "Consultar Ticket Para Modificarlo";
	$projectEntities[ "Tickets_Contratistas" ] = array( "url" => "tickets_contratistas", "type" => 1 );
	$projectEntitiesReverse[ "tickets_contratistas" ] = "Tickets_Contratistas";
	$projectEntities[ "Tecnicos_Contratistas" ] = array( "url" => "tecnicos_contratistas", "type" => 1 );
	$projectEntitiesReverse[ "tecnicos_contratistas" ] = "Tecnicos_Contratistas";
	$projectEntities[ "Usiarios_Contratista" ] = array( "url" => "usiarios_contratista", "type" => 1 );
	$projectEntitiesReverse[ "usiarios_contratista" ] = "Usiarios_Contratista";
}
