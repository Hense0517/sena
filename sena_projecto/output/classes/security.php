...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "mega_ya_tecnicos_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	*  For AD it is <provider code><username>
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "mega_ya_tecnicos_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "mega_ya_tecnicos_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "mega_ya_tecnicos_ugrights", $cman->getUserGroupsConnId() );
	}
	...
	public static function  fillTablesOwnerId( $data, $provider ) {
		...
		if( $securityType == stAD && !$provider["useDbGroups"] ) {
			...
			storageSet( "_Reporte de Material Gastado_OwnerID", $userId );
						storageSet( "_Informe de Tickets_OwnerID", $userId );
						storageSet( "_tickets_OwnerID", $userId );
						storageSet( "_ingreso de equipo_OwnerID", $userId );
						storageSet( "_ingreso de materiales_OwnerID", $userId );
						storageSet( "_Gasto general de materiales_OwnerID", $userId );
						storageSet( "_cargue de materiales_OwnerID", $userId );
						storageSet( "_Equipos Libres_OwnerID", $userId );
						storageSet( "_logistica inversa_OwnerID", $userId );
						storageSet( "_inventario_ general_OwnerID", $userId );
						storageSet( "_inventario_ general_consulta_OwnerID", $userId );
						storageSet( "_Onts Cargadas_OwnerID", $userId );
						storageSet( "_Instalaciones_OwnerID", $userId );
						storageSet( "_Mantenimientos_OwnerID", $userId );
						storageSet( "_Equipos Entregados a Bodega_OwnerID", $userId );
						storageSet( "_Retiros_OwnerID", $userId );
						storageSet( "_Logistica Inversa Para Admin_OwnerID", $userId );
						storageSet( "_Equipos sin entregar a Bodega_OwnerID", $userId );
						storageSet( "_Material Reintegrado a Bodega_OwnerID", $userId );
						storageSet( "_Material Recuperado_OwnerID", $userId );
						storageSet( "_admin_members_OwnerID", $userId );
						storageSet( "_admin_users_OwnerID", $userId );
						storageSet( "_usuarios_OwnerID", $userId );
						storageSet( "_Cargue de Onts Contratista_OwnerID", $userId );
						storageSet( "_Logistica Inversa Para Contratistas_OwnerID", $userId );
						storageSet( "_Cargue Material A Bodega Contratistas_OwnerID", $userId );
						storageSet( "_Cargue de Material a Tecnicos Contratistas_OwnerID", $userId );
						storageSet( "_Inventario_Contratistas_OwnerID", $userId );
						storageSet( "_Consultar empresa de Usuarios1_OwnerID", $userId );
						storageSet( "_Tickets_Contratistas_OwnerID", $userId );
						storageSet( "_Tecnicos_Contratistas_OwnerID", $userId );
						storageSet( "_Usiarios_Contratista_OwnerID", $userId );
		} else {
						storageSet( "OwnerID", $data["Cedula"] );
			storageSet( "_Reporte de Material Gastado_OwnerID", $data["Cedula"] );
						storageSet( "_Informe de Tickets_OwnerID", $data["Cedula"] );
						storageSet( "_tickets_OwnerID", $data["Cedula"] );
						storageSet( "_ingreso de equipo_OwnerID", $data["Cedula"] );
						storageSet( "_ingreso de materiales_OwnerID", $data["Cedula"] );
						storageSet( "_Gasto general de materiales_OwnerID", $data["Cedula"] );
						storageSet( "_cargue de materiales_OwnerID", $data["Cedula"] );
						storageSet( "_Equipos Libres_OwnerID", $data["Cedula"] );
						storageSet( "_logistica inversa_OwnerID", $data["Cedula"] );
						storageSet( "_inventario_ general_OwnerID", $data["Cedula"] );
						storageSet( "_inventario_ general_consulta_OwnerID", $data["Cedula"] );
						storageSet( "_Onts Cargadas_OwnerID", $data["Cedula"] );
						storageSet( "_Instalaciones_OwnerID", $data["Cedula"] );
						storageSet( "_Mantenimientos_OwnerID", $data["Cedula"] );
						storageSet( "_Equipos Entregados a Bodega_OwnerID", $data["Cedula"] );
						storageSet( "_Retiros_OwnerID", $data["Cedula"] );
						storageSet( "_Logistica Inversa Para Admin_OwnerID", $data["Cedula"] );
						storageSet( "_Equipos sin entregar a Bodega_OwnerID", $data["Cedula"] );
						storageSet( "_Material Reintegrado a Bodega_OwnerID", $data["Cedula"] );
						storageSet( "_Material Recuperado_OwnerID", $data["Cedula"] );
						storageSet( "_admin_members_OwnerID", $data["Cedula"] );
						storageSet( "_admin_users_OwnerID", $data["Cedula"] );
						storageSet( "_usuarios_OwnerID", $data["Cedula"] );
						storageSet( "_Cargue de Onts Contratista_OwnerID", $data["Empresa"] );
						storageSet( "_Logistica Inversa Para Contratistas_OwnerID", $data["Empresa"] );
						storageSet( "_Cargue Material A Bodega Contratistas_OwnerID", $data["Empresa"] );
						storageSet( "_Cargue de Material a Tecnicos Contratistas_OwnerID", $data["Empresa"] );
						storageSet( "_Inventario_Contratistas_OwnerID", $data["Empresa"] );
						storageSet( "_Consultar empresa de Usuarios1_OwnerID", $data["Cedula"] );
						storageSet( "_Tickets_Contratistas_OwnerID", $data["Empresa"] );
						storageSet( "_Tecnicos_Contratistas_OwnerID", $data["Empresa"] );
						storageSet( "_Usiarios_Contratista_OwnerID", $data["Empresa"] );
		}
	}
