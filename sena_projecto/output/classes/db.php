...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "mega_ya_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "cargue de materiales", "varname" => "mega_ya_at_localhost__cargue_de_materiales", "altvarname" => "cargue_de_materiales", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "clientes", "varname" => "mega_ya_at_localhost__clientes", "altvarname" => "clientes", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "datos de red", "varname" => "mega_ya_at_localhost__datos_de_red", "altvarname" => "datos_de_red", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "empresas", "varname" => "mega_ya_at_localhost__empresas", "altvarname" => "empresas", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "ingreso de equipo", "varname" => "mega_ya_at_localhost__ingreso_de_equipo", "altvarname" => "ingreso_de_equipo", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "ingreso de materiales", "varname" => "mega_ya_at_localhost__ingreso_de_materiales", "altvarname" => "ingreso_de_materiales", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "inventario_ general", "varname" => "mega_ya_at_localhost__inventario__general", "altvarname" => "inventario__general", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "localidades", "varname" => "mega_ya_at_localhost__localidades", "altvarname" => "localidades", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "logistica inversa", "varname" => "mega_ya_at_localhost__logistica_inversa", "altvarname" => "logistica_inversa", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "materiales", "varname" => "mega_ya_at_localhost__materiales", "altvarname" => "materiales", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "mega_ya_tecnicos_audit", "varname" => "mega_ya_at_localhost__mega_ya_tecnicos_audit", "altvarname" => "mega_ya_tecnicos_audit", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "mega_ya_tecnicos_locking", "varname" => "mega_ya_at_localhost__mega_ya_tecnicos_locking", "altvarname" => "mega_ya_tecnicos_locking", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "mega_ya_tecnicos_uggroups", "varname" => "mega_ya_at_localhost__mega_ya_tecnicos_uggroups", "altvarname" => "mega_ya_tecnicos_uggroups", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "mega_ya_tecnicos_ugmembers", "varname" => "mega_ya_at_localhost__mega_ya_tecnicos_ugmembers", "altvarname" => "mega_ya_tecnicos_ugmembers", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "mega_ya_tecnicos_ugrights", "varname" => "mega_ya_at_localhost__mega_ya_tecnicos_ugrights", "altvarname" => "mega_ya_tecnicos_ugrights", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "tickets", "varname" => "mega_ya_at_localhost__tickets", "altvarname" => "tickets", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "mega_ya_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "mega_ya_at_localhost", "schema" => "", "connName" => "prueba at localhost");
		}
	}
