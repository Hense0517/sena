...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("materiales" == $this->chrt_array['tables'][0])
			return true;
		if("localidades" == $this->chrt_array['tables'][0])
			return true;
		if("ingreso de materiales" == $this->chrt_array['tables'][0])
			return true;
		if("tickets" == $this->chrt_array['tables'][0])
			return true;
		if("tickets" == $this->chrt_array['tables'][0])
			return true;
		if("ingreso de equipo" == $this->chrt_array['tables'][0])
			return true;
		if("ingreso de materiales" == $this->chrt_array['tables'][0])
			return true;
		...
		if("ingreso de materiales" == $this->chrt_array['tables'][0])
			return true;
		if("cargue de materiales" == $this->chrt_array['tables'][0])
			return true;
		if("ingreso de equipo" == $this->chrt_array['tables'][0])
			return true;
		if("logistica inversa" == $this->chrt_array['tables'][0])
			return true;
		if("clientes" == $this->chrt_array['tables'][0])
			return true;
		if("datos de red" == $this->chrt_array['tables'][0])
			return true;
		if("inventario_ general" == $this->chrt_array['tables'][0])
			return true;
		if("inventario_ general" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_audit" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_locking" == $this->chrt_array['tables'][0])
			return true;
		if("ingreso de equipo" == $this->chrt_array['tables'][0])
			return true;
		if("tickets" == $this->chrt_array['tables'][0])
		...
		if("ingreso de materiales" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("mega_ya_tecnicos_ugrights" == $this->chrt_array['tables'][0])
