...
require_once("include/cargue_de_material_a_tecnicos_contratistas_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Cargue de Material a Tecnicos Contratistas" );
