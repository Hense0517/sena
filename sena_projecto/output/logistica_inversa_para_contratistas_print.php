...
require_once("include/logistica_inversa_para_contratistas_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Logistica Inversa Para Contratistas" );
