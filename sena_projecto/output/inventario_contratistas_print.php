...
require_once("include/inventario_contratistas_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Inventario_Contratistas" );
