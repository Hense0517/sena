...
require_once("include/cargue_de_materiales_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cargue de materiales" );
